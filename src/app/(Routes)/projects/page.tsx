...
const Page = () => {
  return (
    <div 
      id="projects" 
      className="w-full min-h-screen scroll-mt-22 px-4 pt-10
      md:pt-0">
      <h2 
        className="text-lg text-[rgb(59,144,197)] uppercase 
      ...
      <div 
        ...
        <Projectprops
          topic="Form Builder"
          text="FormBuilder is a user-friendly tool for creating and sharing custom forms, 
          allowing creators to receive responses directly via email."
        ...
        <Projectprops
          topic="Taskify"
          text="I developed a to-do list app using HTML, Tailwind CSS, and JavaScript,
           delivering a user-friendly experience to boost your productivity."
        ...
        <Projectprops
          topic="Translator"
          text="Designed and developed a translator using a combination of 
          HTML, CSS, JavaScript and google translate api."
